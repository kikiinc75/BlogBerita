...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<!-- form start -->
		<form action="<?= base_url() . 'admin/news/update/' . $news->id ?>" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputEmail3" placeholder="Title" value="<?= set_value('title', $news->title) ?>" name="title">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control" name="status">
								<option value="inactive" <?= set_value('status', $news->status) == 'inactive' ? 'selected' : '' ?>>Draft</option>
								<option value="active" <?= set_value('status', $news->status) == 'active' ? 'selected' : '' ?>>Publish</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control" name="featured">
								<option value="0" <?= set_value('featured', $news->featured) == 0 ? 'selected' : '' ?>>Inactive</option>
								<option value="1" <?= set_value('featured', $news->featured) == 1 ? 'selected' : '' ?>>Active</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputEmail3" placeholder="Subtitle" value="<?= set_value('subtitle', $news->subtitle) ?>" name="subtitle">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea id="editor0" name="excerpt" rows="10" cols="80" class="form-control"><?= set_value('excerpt', $news->excerpt) ?></textarea>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea id="editor2" name="description" rows="10" cols="80"><?= set_value('description', $news->description) ?></textarea>
			...
			<div class="box">
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputEmail3" placeholder="Meta Title" value="<?= set_value('meta_title', $news->meta_title) ?>" name="meta_title">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputEmail3" placeholder="Meta Keyword" value="<?= set_value('meta_keyword', $news->meta_keyword) ?>" name="meta_keyword">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control" id="inputEmail3" placeholder="Meta Description" name="meta_description"><?= set_value('meta_description', $news->meta_description) ?></textarea>
			...
			<div class="box">
				<div class="box-footer">
					<button type="submit" class="btn btn-success pull-right create" style="margin-left: 15px">Update</button>
